...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant in the EnerCost Analyzer app. Your task is to generate a short, encouraging, and easy-to-understand summary of an energy cost simulation. Use a friendly and professional tone.
