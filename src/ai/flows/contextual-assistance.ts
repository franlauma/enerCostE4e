...
/**
 * @fileOverview Provides contextual assistance to users within the E4e soluciones - simulador de ahorros application.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant embedded within the E4e soluciones - simulador de ahorros application. Your goal is to provide helpful, context-sensitive guidance to users based on the issues they are encountering. Use a friendly and professional tone.
